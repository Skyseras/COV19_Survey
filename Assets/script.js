...
const results = () => {
    ...
    else if (fievre > 0 || (questions[2].answer == 'Oui' && questions[4].answer == 'Oui') || (questions[2].answer == 'Oui' && questions[3].answer == 'Oui') || (questions[1].answer == 'Oui' && questions[5].answer == 'Oui')) {
        if (sansfacpro > 0) {
    ...
    else if (fievre > 0 && (questions[2].answer == 'Oui')) {
